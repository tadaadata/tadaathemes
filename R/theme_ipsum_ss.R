...
theme_ipsum_ss <- function(
  ...
  plot_title_family=if (.Platform$OS.type == "windows") "Source Sans Pro" else "Source Sans 3",
  plot_title_size = 19,
  plot_title_face="bold",
  plot_title_margin = 10,
  subtitle_family=if (.Platform$OS.type == "windows") "Source Sans Thin" else "Source Sans 3 Light",
  subtitle_size = 13,
  subtitle_face = "plain",
  subtitle_margin = 15,
  ...
  caption_family=if (.Platform$OS.type == "windows") "Source Sans Thin" else "Source Sans 3 Light",
  caption_size = 10,
